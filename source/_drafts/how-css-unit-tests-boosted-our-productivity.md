...
With another big goal down the line, we faced scaling our framework way over what we than had. To meet a tight deadline, we took other developers on the team. After all, a bigger team means that things go faster – that’s how it’s supposed to work, isn’t it?
